import { Home, Database, BarChart2, FileText, Share2, Settings } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const menuItems = [
  ...
  { title: "Analysis", icon: BarChart2, url: "/analysis" },
  { title: "Reports", icon: FileText, url: "/reports" },
  { title: "Shared", icon: Share2, url: "/shared" },
